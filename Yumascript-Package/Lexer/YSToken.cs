...
public class YSToken
{
	...
	public static List<YSWordMatcher> SpecialCharacters = new List<YSWordMatcher>
	{
		...
		new YSWordMatcher(TokenType.Percentage, 		"%"),
	...
	{
		new YSWordMatcher(TokenType.Import, 	"import"),
		...
		new YSWordMatcher(TokenType.Set, 		"set"),
		new YSWordMatcher(TokenType.Global, 	"global"),
		new YSWordMatcher(TokenType.Parent, 	"parent"),
		new YSWordMatcher(TokenType.Output, 	"output"),
